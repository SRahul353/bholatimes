...
@section('title', 'অনুসন্ধান ফলাফল: "' . $query . '" | দৈনিক ভোলা টাইমস্')
    ...
    <div class="archive-container">
        ...
        <div>
            ...
            <div class="category-header">
                <h1 class="category-header-title">অনুসন্ধান ফলাফল</h1>
                <p class="category-header-desc">"{{ $query }}" এর জন্য অনুসন্ধানকৃত সংবাদসমূহ নিচে দেওয়া হলো।</p>
            </div>
            ...
            @else
                <div class="sidebar-card text-center" style="padding: 60px; font-family: 'Noto Sans Bengali', sans-serif;">
                    <i class="fa-solid fa-circle-question" style="font-size: 3rem; color: var(--text-light); margin-bottom: 16px;"></i>
                    <p style="font-size: 1.15rem; color: var(--text-dark); font-weight: 700; margin-bottom: 8px;">দুঃখিত, আপনার অনুসন্ধানকৃত শব্দের জন্য কোনো সংবাদ পাওয়া যায়নি।</p>
                    <p style="font-size: 0.95rem; color: var(--text-light); margin: 0;">ভিন্ন বা সঠিক বানানের কোনো শব্দ দিয়ে পুনরায় চেষ্টা করুন।</p>
                </div>
            @endif
        </div>
