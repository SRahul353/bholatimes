                        ...
                        <div class="card p-3 border-secondary" style="background-color: rgba(30, 41, 59, 0.2); border: 1px solid rgba(255,255,255,0.08); border-radius: var(--radius-md);">
                            <div class="row g-3">
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <span class="form-text" style="font-size: 0.75rem; color: var(--text-sub);">নতুন ছবি আপলোড করলে ফিচার্ড ইমেজটি প্রতিস্থাপিত হয়ে সোশ্যাল কার্ডে দৃশ্যমান হবে। আপলোড না করলে মূল ফিচার্ড ইমেজটিই কার্ডে ব্যবহৃত হবে।</span>
                                </div>
...
@section('scripts')
    ...
    <script>
    // Global state variables to manage live background card preview
    let featuredImageSrc = '';
    let socialCardImageSrc = '';
    ...
    // Format and inject dynamic Bengali Date (Today's Date)
    ...
    function download_SocialCard(e) {
        ...
        html2canvas(node, {
            ...
            link.download = 'NewsCard-BholaTimes-NewPost.jpg';
